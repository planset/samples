==========================================================================
■02_Welcomeプロジェクトについて

このプロジェクトは画面に「ようこそアプリ開発へ！」という文字列を表示するアプリを作成するためのプロジェクトです。
==========================================================================
■ファイルの説明
...
ストーリーボードファイル。ラベルが配置されており、「ようこそアプリ開発へ！」という文字列が設定されている。
...
ViewController.{h,m}
「ようこそアプリ開発へ！」という文字列が乗る『ビュー』をコントロールするファイル。
