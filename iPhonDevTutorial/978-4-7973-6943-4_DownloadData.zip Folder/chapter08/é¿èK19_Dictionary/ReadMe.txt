==========================================================================
■19_Dictionaryプロジェクトについて

このプロジェクトは辞書を表示するアプリを作成するためのプロジェクトです。
==========================================================================
■ファイルの説明
...
ViewController.{h,m}
ビューをコントロールするクラスファイル。サーチバーに入力された単語をもとに、辞書画面を生成して表示する処理が記述されたファイル。

Dictionary-Info.plist
アプリの設定ファイル。

Dictionary-Prefix.pch
コンパイル済ヘッダファイル。すべてのヘッダファイルに読み込まれる。前もってコンパイルしておくので、以降アプリがビルドされるときにはコンパイルをし直す必要がなく、ビルドの時間を短縮できる。

Dictionary.xcodeproj
プロジェクトファイル。
===========================================================================
■動作環境
