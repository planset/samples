==========================================================================
■13_TextFieldプロジェクトについて

このプロジェクトはテキストフィールドに入力した文字列をラベルに表示するアプリを作成するためのプロジェクトです。
==========================================================================
■ファイルの説明
...
ストーリーボードファイル。ラベルとテキストフィールドが配置されている。
...
ViewController.{h,m}
ビューをコントロールするクラスファイル。テキストフィールドに入力された文字列を取り出してラベルに設定する処理が記述されている。

TextField-Info.plist
アプリの設定ファイル。

TextField-Prefix.pch
