==========================================================================
■15_AlertViewプロジェクトについて

このプロジェクトはスライダーをスライドすることでラベルに表示するスライダーの値を表示するアプリを作成するためのプロジェクトです。
==========================================================================
■ファイルの説明
...
ストーリーボードファイル。アラートビューを表示するきっかけとなるボタンが配置されている。
...
ViewController.{h,m}
ビューをコントロールするクラスファイル。アラートビューを生成して表示する処理が記述されているファイル。
