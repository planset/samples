...
comments = sa.Table(table_prefix + 'comments', metadata,
    ...
    sa.ForeignKeyConstraint(['comment_post_ID'], [table_prefix + 'posts.ID']),
    sa.ForeignKeyConstraint(['comment_parent'], [table_prefix + 'comments.comment_ID']),
    sa.ForeignKeyConstraint(['user_id'], [table_prefix + 'users.ID']),
)

links = sa.Table(table_prefix + 'links', metadata,
    ...
    sa.ForeignKeyConstraint(['link_owner'], [table_prefix + 'users.ID']),
)

options = sa.Table(table_prefix + 'options', metadata,
...
postmeta = sa.Table(table_prefix + 'postmeta', metadata,
    ...
    sa.ForeignKeyConstraint(['post_id'], [table_prefix + 'posts.ID']),
)

posts = sa.Table(table_prefix + 'posts', metadata,
    ...
    sa.ForeignKeyConstraint(['post_author'], [table_prefix + 'users.ID']),
    sa.ForeignKeyConstraint(['post_parent'], [table_prefix + 'posts.ID']),
)

term_relationships = sa.Table(table_prefix + 'term_relationships', metadata,
    ...
    sa.ForeignKeyConstraint(['term_taxonomy_id'], [table_prefix + 'term_taxonomy.term_taxonomy_id']),
)

term_taxonomy = sa.Table(table_prefix + 'term_taxonomy', metadata,
    sa.Column('term_taxonomy_id', sa.Integer(), primary_key=True, nullable=False),
    ...
    sa.ForeignKeyConstraint(['term_id'], [table_prefix + 'terms.term_id']),
    sa.ForeignKeyConstraint(['parent'], [table_prefix + 'term_taxonomy.term_taxonomy_id']),
)

terms = sa.Table(table_prefix + 'terms', metadata,
...
usermeta = sa.Table(table_prefix + 'usermeta', metadata,
...
users = sa.Table(table_prefix + 'users', metadata,
    sa.Column('ID', sa.Integer(), primary_key=True, nullable=False),
